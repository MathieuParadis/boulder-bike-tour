      ...
      <div className="menu">
        ...
        <div className="my-3 py-2">
          <a href="https://twitter.com/" target="_blank">
            <FontAwesomeIcon icon="fa-brands fa-twitter" size="3x" className="social-networks me-1 text-white"/>
          </a>
          <a href="https://facebook.com/" target="_blank">
            <FontAwesomeIcon icon="fa-brands fa-facebook-f" size="3x" className="social-networks mx-3 text-white"/>
          </a>
          <a href="https://instagram.com/" target="_blank">
            <FontAwesomeIcon icon="fa-brands fa-instagram" size="3x" className="social-networks ms-1 text-white"/>
          </a>
        </div>
